...
public class HomeController : BaseController
{
    ...
    private readonly ISubscriptionUsersRepository subscriptionUsersRepository;
    private readonly IMeteringLogsRepository meteringLogsRepository;
    ...
    public HomeController(
        ...
        ISubscriptionUsersRepository subscriptionUsersRepository,
        IMeteringLogsRepository meteringLogsRepository) : base(appVersionService)
    {
        ...
        this.meteringLogsRepository = meteringLogsRepository;
    ...
    public IActionResult UserMeteringLogs(int userId)
    {
       var userLogs = this.meteringLogsRepository.GetLogsByUserId(userId);
        return this.View(userLogs);
    }
    public IActionResult SubscriptionUsers(Guid subscriptionId)
    {
        var subscriptionUsers = this.subscriptionUsersRepository.GetUsersByAmpSubscriptionId(subscriptionId);
        return this.View(subscriptionUsers);
    }
    /// <summary>
