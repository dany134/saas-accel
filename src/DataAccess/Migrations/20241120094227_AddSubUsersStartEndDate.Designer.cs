...
namespace Marketplace.SaaS.Accelerator.DataAccess.Migrations
{
    ...
    [Migration("20241120094227_AddSubUsersStartEndDate")]
    partial class AddSubUsersStartEndDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Marketplace.SaaS.Accelerator.DataAccess.Entities.MeteringLogs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Marketplace.SaaS.Accelerator.DataAccess.Entities.SubscriptionUsers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserEmail", "AmpSubscriptionId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Marketplace.SaaS.Accelerator.DataAccess.Entities.MeteringLogs", b =>
                {
                    b.HasOne("Marketplace.SaaS.Accelerator.DataAccess.Entities.MeteredDimensions", "MeteredDimension")
                        .WithMany("MeteringLogs")
                        .HasForeignKey("DimensionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("Marketplace.SaaS.Accelerator.DataAccess.Entities.SubscriptionUsers", "SubscriptionUser")
                        .WithMany("MeteringLogs")
                        .HasForeignKey("SubscriptionUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MeteredDimension");
